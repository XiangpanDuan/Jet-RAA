...
CSHEN======set up output file for hydro evolution history===================
     ...
     &                      3802, 'results/JetCtl.dat')
         Call writeHydroCtlSparse(NX0,NX,DX,5,NY0,NY,DY,5,T0,DT,1)   ! changed by Xiangpan Duan
#endif
      endif
...
#else
         Call writeHydroBlockSparse(Time,Ed*HbarC,Sd,Temp*HbarC,Vx,Vy)   ! changed by Xiangpan Duan
#endif
